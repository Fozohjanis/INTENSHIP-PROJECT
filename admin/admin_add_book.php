...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO books (title, author, description, price, category, image_path, rating, is_promo, promo_price) 
                           VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->execute([$title, $author, $description, $price, $category, $imagePath, $rating, $isPromo, $promoPrice]);
                ...
                <div class="dashboard-sidebar">
                    ...
                    <nav class="dashboard-menu">
                        <ul>
                            ...
                            <li><a href="admin_add_book.php" class="active"><i class="fas fa-plus-circle"></i> Add Book</a></li>
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="checkbox-container">
                                    <input type="checkbox" id="is_promo" name="is_promo">
                                    <span class="checkmark"></span>
                                    This book is on promotion
                                </label>
                            </div>
                            
                            <div class="form-group promo-price-group" style="display:none;">
